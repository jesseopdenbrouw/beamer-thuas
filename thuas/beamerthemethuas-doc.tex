...
\item Het standaard font voor formules is Libertinus
...
\begin{frame}[fragile]{THUAS Beamer Slides}
\begin{itemize}
\item Als je handouts wilt maken, gebruik dan de \lstinline|handou| optie
\begin{itemize}
\item Gebruik\lstinline|\documentclass[handout]{beamer}|
\item Dit wordt door \lstinline|beamer| ondersteund
\end{itemize}
\item Als je het totaal aantal slides wilt afdrukken
\begin{itemize}
