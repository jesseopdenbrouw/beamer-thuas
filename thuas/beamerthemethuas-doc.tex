...
\item De titelslide is conform de regels
\begin{itemize}
...
\begin{itemize}
\item Officieel?
\item Gebruik \lstinline|\usetheme[official]{thuas}| voor een offici\"ele titelpagina.
\item Gebruik \lstinline|\usetheme[moreofficial]{thuas}| om aan de linkerkant de THUAS-groene polygon te krijgen.
\item Gebruik \lstinline|\usetheme[realyofficial]{thuas}| om ook nog een \textsl{transfade} tussen twee slides te krijgen.
\end{itemize}
\end{frame}
