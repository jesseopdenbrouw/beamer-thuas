...
\frametitle{THUAS Beamer Slides}
\begin{itemize}
\item Soms wil je een tweede titelpagina maken, bijvoorbeeld voor de tweede les, maar de slides bij elkaar houden.
\item Gebruik dan \lstinline|\maketitleagain|
\begin{lstlisting}
\subtitle{Tweede les: kwantumfysica}
\maketitleagain
\end{lstlisting}
\item Dit zorgt ervoor dat het paginanummer en het logo worden onderdrukt.
\item Als je \emph{eerste} pagina geen titelpagina is, gebruik dan \lstinline|\maketitleagain|
\end{itemize}
\end{frame}
\begin{frame}
...
\subtitle{Dit is een tweede titelpagina}
\maketitleagain
